...
<h3 align="center"><u>All Hotel Bookings</u></h3> 
...
<td><c:out value="${h.contact}" /></td> 
<td><c:out value="${h.email}" /></td> 
<td><c:out value="${h.hotel}" /></td> 
<td><c:out value="${h.checkindate}" /></td> 
<td><c:out value="${h.checkintime}" /></td> 
<td><c:out value="${h.checkoutdate}" /></td> 
<td><c:out value="${h.checkouttime}" /></td> 
...
<h3 align="center"><u>All Rental Bookings</u></h3> 
